      ...
      <div className="SkillsContainer">
        <div className="SkillsPageContainer">
          ...
          <ul className="Components">
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/java.webp" loading="eager" width="50px" height="50px" />
                <h3>Java Language</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/ruby.webp" loading="eager" width="50px" height="50px" />
                <h3>Ruby Language</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/ts.webp" loading="eager" width="50px" height="50px" />
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/pgp.webp" loading="eager" width="50px" height="50px" />
                <h3>PHP Language</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/gradle.webp" loading="eager" width="50px" height="50px" />
                <h3>Gradle</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/git.webp" loading="eager" width="50px" height="50px" />
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/react.webp" loading="eager" width="50px" height="50px" />
                <h3>React.js</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/next.webp" loading="eager" width="50px" height="50px" />
                <h3>Next.js</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/spring.webp" loading="eager" width="50px" height="50px" />
                <h3>Spring Boot</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/nest.webp" loading="eager" width="50px" height="50px" />
                <h3>Nest.js</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/sass.webp" loading="eager" width="50px" height="50px" />
                <h3>Sass</h3>
              </div>
            ...
            <div className="Item">
              <div className="Content">
                <img alt="Kotlin" src="/mysql.webp" loading="eager" width="50px" height="50px" />
                <h3>Databases</h3>
              </div>
